...
public class TicketController {
    ...
    public @ResponseBody List<TicketStatusCount> getAllStatusBasedTicketsCountForApprover(
        ...
        return ticketService.getAllStatusBasedTicketsCountForApprover(authorisationToken, username);
    }
    ...
    public @ResponseBody List<TicketStatusCount> getAllStatusBasedTicketsCount(
        ...
        return ticketService.getAllTicketCountOnStatus(authorisationToken, username);
    }
    ...
    public @ResponseBody List<TicketDTO> getAllStatusBasedTicketsOfUser(
            ...
            @RequestHeader(value = "username") String username,
            @PathVariable("status") String status) {
        return ticketService.getAllStatusBasedTicketsOfUserr(authorisationToken, username,status);
    } 
}
