...
public class ManagerController {
    ...
    public @ResponseBody List<TeamDTO> getAllTeams(
        ...
        return teamService.getAllTeamsUnderManager(authorisationToken, username);
    }
    ...
    @RequestMapping(value = "/getEmployeesNotInPaticularTeam", method = RequestMethod.POST)
    public @ResponseBody List<EmployeeDTO> getEmployeesNotInPaticularTeam(
            @RequestHeader(value = "authorisationToken") String authorisationToken,
            @RequestHeader(value = "username") String username,
            @RequestBody TeamDTO team) {
        return teamService.getEmployeesNotInPaticularTeam(authorisationToken, username,team.getTeamName());
    }
    ...
    public @ResponseBody List<TeamDTO> getTeamsByEmployee(
        ...
        return teamService.getTeamsByEmployee(authorisationToken, username,employeeDto.getLogin().getUsername());
    }
    ...
    public @ResponseBody List<TeamDTO> getTeamsByEmployee(
            @RequestHeader(value = "authorisationToken") String authorisationToken,
            @RequestHeader(value = "username") String username) {
        return teamService.getTeamsByEmployee(authorisationToken, username,username);
    }
