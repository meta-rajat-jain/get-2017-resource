...
@Transactional
public class ResourceCategoryDAOImpl extends GenericDAO implements ResourceCategoryDAO {
    ...
    public ResourceCategory getResourceCategoryByName(String categoryName){
        ...
        ResourceCategory resourceCategory = (ResourceCategory) cr.uniqueResult();
