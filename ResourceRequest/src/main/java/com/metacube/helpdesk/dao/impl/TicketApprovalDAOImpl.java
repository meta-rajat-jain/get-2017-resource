...
public class TicketApprovalDAOImpl implements TicketApprovalDAO {
    ...
    public List<TicketStatusCount> getTicketsCountOfHelpDeskBasedOnStatus() {
        ...
        Criteria cr = session.createCriteria(TicketApproval.class)
            .setProjection(Projections.projectionList()
                ...
                .add(Projections.groupProperty("helpdeskApprovalStatus"),"helpdeskApprovalStatus")
                .add(Projections.count("ticketApprovalId"),"count")
                );
	...
	@Override
	public List<TicketStatusCount> getTicketsCountOfApproverBasedOnStatus(Employee employee) {
        ...
        Criteria cr = session.createCriteria(TicketApproval.class)
        	...
        	.setProjection(Projections.projectionList()
                ...
                .add(Projections.groupProperty("approveStatus"),"approveStatus")
                .add(Projections.count("ticketApprovalId"),"count")
                );
        List<Object> results = cr.list();
        for (Object r : results) {
