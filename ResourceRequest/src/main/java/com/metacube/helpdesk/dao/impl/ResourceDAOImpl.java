...
@Transactional
public class ResourceDAOImpl extends GenericDAO implements ResourceDAO {
    ...
    public ResourceDAOImpl() {
        super(ItResource.class);
    }
    
    @Override
    public List<ItResource> getAllCategoryBasedResources(ResourceCategory resourceCategory) {
        Session session = this.sessionFactory.getCurrentSession();
        // Criteria query
        Criteria cr = session.createCriteria(ItResource.class)
