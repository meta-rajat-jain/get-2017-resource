...
public class LoginDAOImpl implements LoginDAO {
    ...
    /**
     * @param String
     *            username to get login for
     * @return login object corresponding to username
     */
    @Override
    ...
    /**
     * create a login instance in database
     * 
     * @param Login
     *            object to save
     * @return Status flag
    ...
    /**
     * to update authorisation token for current user session
     * 
     * @param String
     *            username to get login for
     * @return a corresponding response object
     */
    @Override
    ...
    /**
     * to update login tuple in database with updated login object
     * 
     * @param the
     *            login object to update
     * @return the status flag for query execution
     */
    @Override
