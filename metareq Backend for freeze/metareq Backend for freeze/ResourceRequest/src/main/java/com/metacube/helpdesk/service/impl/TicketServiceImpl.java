...
public class TicketServiceImpl implements TicketService {
    ...
    /**
     * method performing null empty and pattern check on the TicketDTO object
     * 
     * @param ticketDTO
     * @return
     */
    ...
    /**
     * method to save ticket for resource
     */
    @Override
    public TicketCreationResponse saveTicket(String username,
        ...
        // if team name is not specified
        if (ticketDTO.getTeamName() == null) {
            // if employee is manager set team name as its default team
            if (employeeDAO
    ...
    /**
     * method to save ticket history on each update
     */
    @Override
    ...
    /**
     * method updating the previous ticket
     */
    @Override
    ...
    /**
     * method to get ticket on the basis of ticket number
     */
    @Override
