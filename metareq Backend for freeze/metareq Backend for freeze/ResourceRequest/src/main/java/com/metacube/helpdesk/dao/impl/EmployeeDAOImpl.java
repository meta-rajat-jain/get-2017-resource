...
public class EmployeeDAOImpl implements EmployeeDAO {
    ...
    /**
     * @param Employee
     *            object to be added. Description : Method to update an existing
     *            employee
     * @return Status flag corresponding to the hibernate transaction
     */
    @Override
    ...
    /**
     * This method gives the list of employees whose username is not present in
     * given passed list of login array
     * 
     * @param login
     *            objects array for all employees in a team
     * @return list of employees not in a team
     */
    @Override
