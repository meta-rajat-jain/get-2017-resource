...
public class OrganisationServiceImpl implements OrganisationService {
    ...
    /**
     * method performing null empty and pattern check on the Organisation DTO
     * object
     * 
    ...
    /**
     * method performing creation of the organisation
     */
    @Override
    public Response create(OrganisationDTO organisationDTO) {
        ...
        if (response != null) {
            ...
            // if orgainsation admin already exist
            ...
            // code review: to be made a new method
